...
<tr>
	...
	<td> <input type="number" name="nilai2" class="form-control" value="<?php echo $data['nilai2'];?>"> </td>
</tr>
<tr>
	<td>3.</td>
...
<tr>
	...
	<td> <input type="number" name="nilai5" class="form-control" value="<?php echo $data['nilai5'];?>"> </td>
</tr>
<tr class="info">
...
mysql_query("UPDATE tb_siswa SET username='$username',pass='$pass',password =md5('$pass'),nama_lengkap='$nama_lengkap',jenis_kelamin='$jenis_kelamin',tempat='$tempat',tgl_lahir='$tgl_lahir',anak_ke='$anak_ke',jml_saudara='$jml_saudara',agama='$agama',alamat='$alamat',asal_sekolah='$asal_sekolah',nilai_ijazah='$nilai_ijazah',nisn='$nisn',nilai1='$nilai1',nilai2='$nilai2',nilai3='$nilai3',nilai4='$nilai4',nilai5='$nilai5' WHERE kode_siswa='$kdsis' ") or die(mysql_error());
  ?>
