...
$kdsis = @$_GET['kdsis'];
$sql = mysql_query("select * from tb_user where kode_user = '$kdsis'") or die(mysql_error());
...
mysql_query("update tb_user set username='$username',pass='$pass',password =md5('$pass') where kode_user='$kdsis' ") or die(mysql_error());
  ?>
